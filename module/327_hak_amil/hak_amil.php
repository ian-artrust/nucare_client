        ...
        <div class="row col-md-12">
            <div class="row container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-condensed">
                        <tr>
                            <td colspan='6'>Jurnal 2</td>
                        </tr>
                        <tr>
                            <td>
                                <input type="text" class="form-control" size="10" 
                                name="kode_akun_debit" id="kda_debit" readonly="true"
                                placeholder="Kode Debit ..." >
                            </td>
                            <td>
                                <input type="text" class="form-control" size="20" 
                            ...
                            <td>
                                <button type="button" class="btn btn-success" data-toggle="modal" 
                                data-target="#akunDebit2">
                                    <span class="glyphicon glyphicon-search"></span>
                                </button>
                            </td> 
                            <td>
                                <input type="text" class="form-control" size="10" 
                                name="kda_kredit" id="kda_kredit" readonly="true"
                                placeholder="Kode Kredit ..." >
                            </td>
                            <td>
                                <input type="text" class="form-control" size="20" 
