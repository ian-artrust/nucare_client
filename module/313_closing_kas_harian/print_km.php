            ...
            <div class="row col-md-10">
                ...
                <table width="100%" style="border:none;">
                    <tr style="border:none;">
                        ...
                        <td width="5">:&nbsp;</td>
                        <td contenteditable="true">Nama Direktur / Ketua <td>
                    </tr>
                    <tr style="border:none;">
                        <td width="125">Alamat</td>
                        <td width="5">:&nbsp;</td>
                        <td contenteditable="true">Diisikan alamatnya.....<td>
                    </tr>
                    <tr style="border:none;">
                        <td width="125">Jabatan</td>
                        <td width="5">:&nbsp;</td>
                        <td contenteditable="true">Isikan Jabatannya ....<td>
                    </tr>
                </table>
                <br>
                <table width="100%">
                ...
                <br>
                <p align="justify">Adalah Muzaki dilembaga Amil Zakat Infaq dan Shadaqah Nahdlatul Ulama sejak tahun <span contenteditable="true">---</span> sampai dengan sekarang.</p>
                ...
                <table border="0">
                    ...
                    <tr>
                        <td><span contenteditable="true">NIP/NIK Jika Ada ...</span></td>
                    </tr>
                </table>
            </div>
        </div>
